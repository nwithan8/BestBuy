import setuptools
import bestbuy.__info__ as package_info
...
setuptools.setup(
    ...
    description="Interact with BestBuy's APIs",  # Give a short description about your library
    ...
    url=f'https://github.com/nwithan8/BestBuy',  # Provide either the link to your github or to your website
    download_url=f'https://github.com/nwithan8/BestBuy/archive/{package_info.__version__}.tar.gz',
    keywords=[
      'BestBuy',
      'Best Buy',
      'shopping',
